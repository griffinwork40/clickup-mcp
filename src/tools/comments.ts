/**
 * ClickUp Comments tool definitions.
 * 
 * Tools for managing comments on tasks.
 */
 ...
 */
function registerAddComment(server: McpServer): void {
  server.registerTool(
    "clickup_add_comment",
    {
 ...
 */
function registerGetComments(server: McpServer): void {
  server.registerTool(
