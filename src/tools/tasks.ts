/**
 * ClickUp Tasks tool definitions.
 * 
 * Tools for managing tasks including CRUD operations, search, counting, and export.
 */

import { z } from "zod";
import { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
import { ResponseFormatSchema, ResponseModeSchema, PaginationSchema } from "../schemas/index.js";
...
export function registerTaskTools(server: McpServer): void {
  ...
  registerCountTasksByStatus(server);
  registerExportTasksToCSV(server);
}

/**
 * Tool: Get Tasks in List
 */
function registerGetTasks(server: McpServer): void {
  server.registerTool(
    "clickup_get_tasks",
    {
 ...
 */
function registerGetTask(server: McpServer): void {
  server.registerTool(
    "clickup_get_task",
    {
 ...
 * Tool: Create Task
 */
function registerCreateTask(server: McpServer): void {
  server.registerTool(
    "clickup_create_task",
    {
 ...
 * Tool: Update Task
 */
function registerUpdateTask(server: McpServer): void {
  server.registerTool(
    "clickup_update_task",
    {
 ...
 * Tool: Delete Task
 */
function registerDeleteTask(server: McpServer): void {
  server.registerTool(
    "clickup_delete_task",
    {
 ...
 * Tool: Search Tasks
 */
function registerSearchTasks(server: McpServer): void {
  server.registerTool(
 ...
 */
function registerCountTasksByStatus(server: McpServer): void {
  server.registerTool(
 ...
 */
function registerExportTasksToCSV(server: McpServer): void {
  server.registerTool(
