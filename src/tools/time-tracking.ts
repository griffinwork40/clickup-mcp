/**
 * ClickUp Time Tracking tool definitions.
 * 
 * Tools for managing time entries and time tracking.
 */
...
/**
 * Register all time tracking-related tools with the MCP server.
 */
export function registerTimeTrackingTools(server: McpServer): void {
  registerStartTimeEntry(server);
  registerStopTimeEntry(server);
  registerGetTimeEntries(server);
}

/**
 * Tool: Start Time Tracking
 */
function registerStartTimeEntry(server: McpServer): void {
  server.registerTool(
...
/**
 * Tool: Stop Time Tracking
 */
function registerStopTimeEntry(server: McpServer): void {
  server.registerTool(
 ...
 */
function registerGetTimeEntries(server: McpServer): void {
  server.registerTool(
